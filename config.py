...
OWNER_ID = int(getenv("OWNER_ID", 6718600291))
...
CHANNEL_NAME = getenv("CHANNEL_NAME", "تحديثات ماغي ")
CHANNEL_LINK = getenv("CHANNEL_LINK", "https://t.me/QREAX22")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/QREAX22")
